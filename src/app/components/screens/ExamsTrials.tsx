...
const WRITTEN: ExamResult[] = [
  { id: "e1", student: "Ravishka Rathnayake", studentId: "STD-2026-0052", examType: "Written Examination", attempt: 1, date: "2026-06-12", score: 86, result: "Passed", recordedBy: "Manura Anuhas" },
  { id: "e2", student: "Loshan Mihisara", studentId: "STD-2026-0048", examType: "Written Examination", attempt: 1, date: "2026-05-20", score: 74, result: "Passed", recordedBy: "Manura Anuhas" },
  { id: "e3", student: "Lasindu Dilshan", studentId: "STD-2026-0061", examType: "Written Examination", attempt: 1, date: "2026-06-28", score: 54, result: "Failed", recordedBy: "Admin" },
  { id: "e4", student: "Lasindu Dilshan", studentId: "STD-2026-0061", examType: "Written Examination", attempt: 2, date: "2026-07-15", score: 79, result: "Passed", recordedBy: "Admin" },
  { id: "e5", student: "Nethmi Wijesinghe", studentId: "STD-2026-0068", examType: "Written Examination", attempt: 1, date: "2026-07-10", score: null, result: "Absent", recordedBy: "Manura Anuhas" },
  { id: "e6", student: "Dilhara Senanayake", studentId: "STD-2026-0072", examType: "Written Examination", attempt: 1, date: "2026-07-22", score: null, result: "Pending", recordedBy: "â€”" },
];

const PRACTICAL: ExamResult[] = [
  { id: "p1", student: "Loshan Mihisara", studentId: "STD-2026-0048", examType: "Practical Trial", attempt: 1, date: "2026-07-18", score: null, result: "Pending", recordedBy: "â€”" },
  { id: "p2", student: "Ravishka Rathnayake", studentId: "STD-2026-0052", examType: "Practical Trial", attempt: 1, date: "2026-07-05", score: 88, result: "Passed", recordedBy: "Kasun Silva" },
...
const TRIAL_ELIGIBLE: TrialEligible[] = [
  { id: "t1", student: "Loshan Mihisara", studentId: "STD-2026-0048", permitEligibility: "2026-08-10", sessionsCompleted: 12, sessionsTarget: 15, readinessScore: 84, outstanding: ["3 more practical sessions"] },
  { id: "t2", student: "Ravishka Rathnayake", studentId: "STD-2026-0052", permitEligibility: "2026-07-28", sessionsCompleted: 20, sessionsTarget: 20, readinessScore: 96, outstanding: [] },
...
/* â”€â”€â”€ Record Result Modal â”€â”€â”€ */

function RecordResultModal({ onClose }: { onClose: () => void }) {
  const [form, setForm] = useState({ student: "Loshan Mihisara", examType: "Written Examination", attempt: "1", relatedEvent: "", date: "2026-07-22", score: "", result: "Passed", remarks: "" });
        ...
        <div style={{ padding: "20px 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px 18px" }}>
          <div style={{ gridColumn: "1/-1" }}>
            ...
            <select style={selectStyle} value={form.student} onChange={(e) => setForm({ ...form, student: e.target.value })}>
              {["Loshan Mihisara", "Ravishka Rathnayake", "Lasindu Dilshan", "Nethmi Wijesinghe", "Dilhara Senanayake"].map(s => <option key={s}>{s}</option>)}
            </select>
          </div>
          <div>
...
/* â”€â”€â”€ Trial Eligible table â”€â”€â”€ */
        ...
        <>
          ...
          <div style={{ background: "#ffffff", border: "1px solid #E2E8F0", borderRadius: 12, padding: "12px 16px", marginBottom: 16, display: "flex", gap: 10, alignItems: "center" }}>
            <div style={{ position: "relative", flex: 1 }}>
              ...
              <input placeholder="Search by student nameâ€¦" value={search} onChange={(e) => setSearch(e.target.value)}
